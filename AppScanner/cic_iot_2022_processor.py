...
# Output path
OUTPUT_DIR = "/home/pcz/DL/ML_DL/AppScanner/data/cic_iot_2022"
...
def process_iscxvpn_dataset():
    ...
    pickle_path = output_path / 'cic_iot_2022_appscanner.pkl'
    with open(pickle_path, 'wb') as f:
        pickle.dump(data, f)

    # Also save as npz for convenience
    npz_path = output_path / 'cic_iot_2022_appscanner.npz'
    np.savez(
        npz_path,
        features=features,
        labels=labels,
