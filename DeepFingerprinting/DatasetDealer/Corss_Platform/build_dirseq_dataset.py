...
# ===== 配置 =====
DATASET_KEY     = "cross_platform"    # 需与 make_label_map.py 相同
...
def main():
    ...
    map_csv  = os.path.join(ds_dir, "label_map.csv") #/home/pcz/DL/ML_DL/DeepFingerprinting/DatasetDealer/USTC/artifacts/label_map.csv
