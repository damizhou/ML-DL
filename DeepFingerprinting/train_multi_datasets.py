...
DATASETS: List[DatasetConfig] = [
    DatasetConfig(name='novpn_top1000', data_path='/root/autodl-tmp/data/novpn_top1000'),
    DatasetConfig(name='vpn_top1000', data_path='/root/autodl-tmp/data/vpn_top1000'),
    DatasetConfig(name='novpn_top500', data_path='/root/autodl-tmp/data/novpn_top500'),
    DatasetConfig(name='vpn_top500', data_path='/root/autodl-tmp/data/vpn_top500'),
    DatasetConfig(name='novpn_top100', data_path='/root/autodl-tmp/data/novpn_top100'),
    DatasetConfig(name='vpn_top100', data_path='/root/autodl-tmp/data/vpn_top100'),
    DatasetConfig(name='novpn_top50', data_path='/root/autodl-tmp/data/novpn_top50'),
    DatasetConfig(name='vpn_top50', data_path='/root/autodl-tmp/data/vpn_top50'),
    DatasetConfig(name='vpn_top10', data_path='/root/autodl-tmp/data/vpn_top10'),
]
