"""
FS-Net Multi-Dataset Concurrent Training Script
...
class DatasetConfig:
    ...
    num_classes: Optional[int] = None  # Auto-detect if None
    gpu_id: int = 0              # GPU to use (for multi-GPU systems)
...
def main():
    ...
    print("=" * 70)
    print("FS-Net Multi-Dataset Concurrent Training")
    print("=" * 70)
    ...
    with open(summary_path, 'w', encoding='utf-8') as f:
        f.write(f"FS-Net Multi-Dataset Training Summary\n")
        f.write(f"{'='*70}\n")
